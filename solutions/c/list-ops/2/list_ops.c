...
list_t *new_list(size_t length, list_element_t elements[]) {
  list_t *l =
      (list_t *)malloc(sizeof(list_t) + length * sizeof(list_element_t));
  l->length = length;
...
list_t *append_list(list_t *list1, list_t *list2) {
  list_t *res =
      (list_t *)malloc(sizeof(list_t) + (list1->length + list2->length) *
...
list_t *filter_list(list_t *list, bool (*filter)(list_element_t)) {
  list_t *res =
      (list_t *)malloc(sizeof(list_t) + list->length * sizeof(list_element_t));
  size_t j = 0;
