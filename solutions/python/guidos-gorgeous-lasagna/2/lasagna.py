...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - preparation time (in minutes) needed to prepare the lasagna.

    This function takes one integer representing the number of lasagna layers and
    calculates the total amount of time needed to prepare lasagna with that many layers.
    """
